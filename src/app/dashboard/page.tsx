    ...
    return (
        <div className="flex flex-col lg:flex-row h-screen">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div className="col-span-2 bg-white p-4 sm:p-6 rounded-lg shadow">
                        ...
                        <div className="flex items-center mb-4">
                            <img src="/bluecar.png" alt="Nissan GT-R" className="w-20 h-12 object-cover rounded-lg mr-4" />
                            <div>
                    ...
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow mt-4">
                            ...
                            <ul>
                                {[
                                    { img: "/car (1).png", name: "Nissan GT-R", date: "20 July", price: "$80.00" },
                                    { img: "/car.png", name: "Koenigsegg", date: "19 July", price: "$99.00" },
                                    { img: "/Car (2).png", name: "Rolls-Royce", date: "18 July", price: "$96.00" },
                                    { img: "/c5.png", name: "CR-V", date: "17 July", price: "$80.00" },

                                ].map((transaction, index) => (
                                    <li className="flex justify-between items-center mb-4" key={index}>
                                        <div className="flex items-center">
                                            <img src={transaction.img} alt={transaction.name} className="w-20 h-6 object-cover rounded-lg mr-3" />
                                            <div>
            ...
            <a
                ...
                className="fixed bottom-4 right-4 bg-blue-600 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700 transition-all"
            >
                Proceed to Payment
            </a>
        </div>
